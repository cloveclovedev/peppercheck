...
mixin _$ProfileDto {
 ...
 String get username; String? get avatarUrl; String get timezone; String get createdAt; String get updatedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,username,avatarUrl,timezone,createdAt,updatedAt);

@override
String toString() {
  return 'ProfileDto(username: $username, avatarUrl: $avatarUrl, timezone: $timezone, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 String username, String? avatarUrl, String timezone, String createdAt, String updatedAt
});
...
/// Create a copy of ProfileDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? username = null,Object? avatarUrl = freezed,Object? timezone = null,Object? createdAt = null,Object? updatedAt = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String username,  String? avatarUrl,  String timezone,  String createdAt,  String updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ProfileDto() when $default != null:
return $default(_that.username,_that.avatarUrl,_that.timezone,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String username,  String? avatarUrl,  String timezone,  String createdAt,  String updatedAt)  $default,) {final _that = this;
switch (_that) {
case _ProfileDto():
return $default(_that.username,_that.avatarUrl,_that.timezone,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String username,  String? avatarUrl,  String timezone,  String createdAt,  String updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _ProfileDto() when $default != null:
return $default(_that.username,_that.avatarUrl,_that.timezone,_that.createdAt,_that.updatedAt);case _:
  return null;
...
class _ProfileDto extends ProfileDto {
  const _ProfileDto({required this.username, this.avatarUrl, required this.timezone, required this.createdAt, required this.updatedAt}): super._();
...
/// Create a copy of ProfileDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? username = null,Object? avatarUrl = freezed,Object? timezone = null,Object? createdAt = null,Object? updatedAt = null,}) {
