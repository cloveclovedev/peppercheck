...
mixin _$Task {
 ...
 String get id; String get taskerId; String get title; String? get description; String? get criteria; String? get dueDate; String get status; String? get createdAt; String? get updatedAt;// Aggregated fields
 List<RefereeRequest> get refereeRequests; TaskEvidence? get evidence; PublicProfile? get tasker;
...
@useResult
$Res call({
 String id, String taskerId, String title, String? description, String? criteria, String? dueDate, String status, String? createdAt, String? updatedAt, List<RefereeRequest> refereeRequests, TaskEvidence? evidence, PublicProfile? tasker
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String taskerId,  String title,  String? description,  String? criteria,  String? dueDate,  String status,  String? createdAt,  String? updatedAt,  List<RefereeRequest> refereeRequests,  TaskEvidence? evidence,  PublicProfile? tasker)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Task() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String taskerId,  String title,  String? description,  String? criteria,  String? dueDate,  String status,  String? createdAt,  String? updatedAt,  List<RefereeRequest> refereeRequests,  TaskEvidence? evidence,  PublicProfile? tasker)  $default,) {final _that = this;
switch (_that) {
case _Task():
return $default(_that.id,_that.taskerId,_that.title,_that.description,_that.criteria,_that.dueDate,_that.status,_that.createdAt,_that.updatedAt,_that.refereeRequests,_that.evidence,_that.tasker);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String taskerId,  String title,  String? description,  String? criteria,  String? dueDate,  String status,  String? createdAt,  String? updatedAt,  List<RefereeRequest> refereeRequests,  TaskEvidence? evidence,  PublicProfile? tasker)?  $default,) {final _that = this;
switch (_that) {
case _Task() when $default != null:
return $default(_that.id,_that.taskerId,_that.title,_that.description,_that.criteria,_that.dueDate,_that.status,_that.createdAt,_that.updatedAt,_that.refereeRequests,_that.evidence,_that.tasker);case _:
  return null;
...
class _Task extends Task {
  const _Task({required this.id, required this.taskerId, required this.title, this.description, this.criteria, this.dueDate, required this.status, this.createdAt, this.updatedAt, final  List<RefereeRequest> refereeRequests = const [], this.evidence, this.tasker}): _refereeRequests = refereeRequests,super._();
...
// Aggregated fields
@override@JsonKey() List<RefereeRequest> get refereeRequests {
...
@override final  PublicProfile? tasker;
