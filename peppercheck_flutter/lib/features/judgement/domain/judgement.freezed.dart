...
mixin _$Judgement {
 ...
 String get id; String get status; String? get comment;@JsonKey(name: 'is_confirmed') bool get isConfirmed;@JsonKey(name: 'reopen_count') int get reopenCount;@JsonKey(name: 'is_evidence_timeout_confirmed') bool get isEvidenceTimeoutConfirmed;@JsonKey(name: 'created_at') String get createdAt;@JsonKey(name: 'updated_at') String get updatedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,status,comment,isConfirmed,reopenCount,isEvidenceTimeoutConfirmed,createdAt,updatedAt);

@override
String toString() {
  return 'Judgement(id: $id, status: $status, comment: $comment, isConfirmed: $isConfirmed, reopenCount: $reopenCount, isEvidenceTimeoutConfirmed: $isEvidenceTimeoutConfirmed, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 String id, String status, String? comment,@JsonKey(name: 'is_confirmed') bool isConfirmed,@JsonKey(name: 'reopen_count') int reopenCount,@JsonKey(name: 'is_evidence_timeout_confirmed') bool isEvidenceTimeoutConfirmed,@JsonKey(name: 'created_at') String createdAt,@JsonKey(name: 'updated_at') String updatedAt
});
...
/// Create a copy of Judgement
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? status = null,Object? comment = freezed,Object? isConfirmed = null,Object? reopenCount = null,Object? isEvidenceTimeoutConfirmed = null,Object? createdAt = null,Object? updatedAt = null,}) {
...
as int,isEvidenceTimeoutConfirmed: null == isEvidenceTimeoutConfirmed ? _self.isEvidenceTimeoutConfirmed : isEvidenceTimeoutConfirmed // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String status,  String? comment, @JsonKey(name: 'is_confirmed')  bool isConfirmed, @JsonKey(name: 'reopen_count')  int reopenCount, @JsonKey(name: 'is_evidence_timeout_confirmed')  bool isEvidenceTimeoutConfirmed, @JsonKey(name: 'created_at')  String createdAt, @JsonKey(name: 'updated_at')  String updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Judgement() when $default != null:
return $default(_that.id,_that.status,_that.comment,_that.isConfirmed,_that.reopenCount,_that.isEvidenceTimeoutConfirmed,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
class _Judgement implements Judgement {
  const _Judgement({required this.id, required this.status, this.comment, @JsonKey(name: 'is_confirmed') this.isConfirmed = false, @JsonKey(name: 'reopen_count') this.reopenCount = 0, @JsonKey(name: 'is_evidence_timeout_confirmed') this.isEvidenceTimeoutConfirmed = false, @JsonKey(name: 'created_at') required this.createdAt, @JsonKey(name: 'updated_at') required this.updatedAt});
...
@override@JsonKey(name: 'is_evidence_timeout_confirmed') final  bool isEvidenceTimeoutConfirmed;
...
/// Create a copy of Judgement
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? status = null,Object? comment = freezed,Object? isConfirmed = null,Object? reopenCount = null,Object? isEvidenceTimeoutConfirmed = null,Object? createdAt = null,Object? updatedAt = null,}) {
