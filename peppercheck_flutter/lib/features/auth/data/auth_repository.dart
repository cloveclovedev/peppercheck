...
/// credential; Apple sign-in uses the Firebase-official provider flow; sign-out
/// runs each leg independently and idempotently.
class AuthRepository {
  ...
  /// [AuthCredential] without signing in.
