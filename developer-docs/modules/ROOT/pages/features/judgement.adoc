...
After a Tasker submits evidence, the assigned Referee reviews it and either approves or rejects it.
...
> As a **Referee**, I want to **approve or reject submitted evidence with a comment**, so that the **Tasker receives feedback on their task completion**.
