...
* *Title*: [Feature Name]
* *Prerequisites*: Features or components this depends on (e.g., "Requires xref:features/task.adoc[Task] and xref:features/evidence.adoc[Evidence]").
...
* *Error Cases*: Possible errors and their causes (optional, recommended for RPCs and Edge Functions).
