...
- `docs/designs/2026-05-05-ios-firebase-config-design.md` — single-bundle-ID iOS Firebase configuration (PR #401 merged; this roadmap continues from there).
- `docs/designs/2026-05-09-ios-iap-design.md` — iOS IAP integration design.
- `docs/designs/2026-03-30-google-play-iap-design.md` — Google Play IAP design.
- `docs/designs/2026-05-06-recommend-payout-topup-design.md` — payout top-up recommendation.
- `docs/designs/2026-02-25-deployment-flow-design.md` — existing deployment flow.
