...
- `docs/designs/2026-03-30-google-play-iap-design.md` — Android counterpart, mirrored architecture
- `docs/designs/2026-04-09-subscription-iap-only-design.md` — IAP-only policy
