...
- `docs/designs/2026-05-11-multi-environment-setup-roadmap-design.md` — the umbrella roadmap. Topology in this spec matches its `Stripe` row and "Webhook routing" subsection.
- `docs/designs/2026-04-12-stripe-account-updated-webhook-design.md` — the webhook event this sandbox is used to test locally.
