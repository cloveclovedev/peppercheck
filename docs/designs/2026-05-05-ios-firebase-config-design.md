...
3. `docs: restructure project documentation` — Completed by moving durable
   designs to `docs/designs/`, adding current architecture and setup entry
   points, and removing the pre-Flutter Kotlin documents.
