...
> Phase 0 baseline `docs/designs/2026-07-22-phase0-baseline.md`.
> This is the **Flutter follow-on** to the Phase 4a **backend** spec
> `docs/designs/2026-07-25-phase4a-task-authoring-matching-design.md`
> (its §7 API contract is the source of truth for the endpoints consumed here)
> and its companion `docs/designs/2026-07-25-phase4a-follow-ups.md`.
>
