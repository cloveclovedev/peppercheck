...
**Prerequisite (manual):** Complete Google Play Console setup (subscription products, service account, Pub/Sub topic, RTDN configuration) as documented in `docs/designs/2026-03-30-google-play-iap-design.md` § "Google Play Console Setup".
