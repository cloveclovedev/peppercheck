...
| `2026-07-25-phase3a-backend.md` | Needs revalidation | Reconcile with the chosen Go-maintained `updated_at` convention before execution. |
| `2026-07-25-phase3a-flutter.md` | Needs revalidation | Revalidate after the Phase 3a backend contract lands. |
| `2026-07-25-phase4a-backend.md` | Needs revalidation | Revalidate after Phase 3a and against current backend conventions. |
...
| `2026-07-26-phase4b-evidence-private-r2.md` | Needs revalidation | Existing optional plan; reconcile dependencies and database conventions first. |
