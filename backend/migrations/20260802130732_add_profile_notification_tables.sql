...
CREATE TABLE "user_fcm_tokens" (
  ...
  CONSTRAINT "user_fcm_tokens_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users" ("id") ON UPDATE NO ACTION ON DELETE CASCADE
);
-- Create index "idx_user_fcm_tokens_last_active_at" to table: "user_fcm_tokens"
CREATE INDEX "idx_user_fcm_tokens_last_active_at" ON "user_fcm_tokens" ("last_active_at");
-- Create index "idx_user_fcm_tokens_user_id" to table: "user_fcm_tokens"
