CREATE OR REPLACE FUNCTION public.lock_trial_points(
    p_user_id uuid,
    p_amount integer,
    p_reason public.trial_point_reason DEFAULT 'matching_lock',
...
ALTER FUNCTION public.lock_trial_points(uuid, integer, public.trial_point_reason, text, uuid) OWNER TO postgres;
