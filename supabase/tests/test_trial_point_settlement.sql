...
-- ===== Apply updated function definitions =====
-- The schema files for confirm_judgement_and_rate_referee have been updated to use
-- route_consume_points and route_referee_reward, but a migration has not yet been
-- generated. Apply the updated definitions here so the tests validate the new behavior.
\echo ''
\echo '[Setup] Applying updated confirm_judgement_and_rate_referee...'
