...
CREATE OR REPLACE FUNCTION public.finalize_billing_job(p_job_id uuid, p_payment_intent_id text, p_status public.billing_job_status, p_currency_code text DEFAULT NULL::text, p_amount_minor bigint DEFAULT NULL::bigint, p_error_code text DEFAULT NULL::text, p_error_message text DEFAULT NULL::text)
 RETURNS void
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO ''
